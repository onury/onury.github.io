 ...
 * @license MIT. © 2018, Onur Yıldırım
 */
    ...
    _createClass(geolocator, null, [{
        ...
        value: function locateByIP(options, callback) {
            ...
            if (source.callbackParam) {
                ...
                throw new _geo_error__WEBPACK_IMPORTED_MODULE_3__["default"](_geo_error__WEBPACK_IMPORTED_MODULE_3__["default"].Code.INVALID_GEO_IP_SOURCE, 'Either callbackParam or globalVar should be set for Geo-IP source.');
            }
        ...
        value: function getIP(callback) {
            ...
            return _lib_fetch__WEBPACK_IMPORTED_MODULE_1__["default"].jsonp(jsonpOpts, function (err, response) {
                ...
                if ((typeof response === 'undefined' ? 'undefined' : _typeof(response)) === 'object') response.timestamp = _lib_utils__WEBPACK_IMPORTED_MODULE_0__["default"].time();
                callback(null, response);
            });
        }
